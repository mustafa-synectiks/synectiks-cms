					...
					<div className='d-flex flex-column flex-md-row justify-content-around py-2 py-md-5'>
						<div className='px-2 px-md-5'>
							...
							<p>
								...
								ERP, Big Data Analysis and IOT require a latest all-flash solution. Synectiks provides a
								wide range of storage solutions and has years of expertise in this domain. We enable
								enterprises, around the globe to connect to cloud-based IT capabilities, help optimize
								costs, enhance productivity and bring innovation to IT operations.
							</p>
						</div>
						<div>
