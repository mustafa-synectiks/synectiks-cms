								...
								<div className='w-100  text-black'>
									...
									<p className='lineHeight-24'>
										...
										<ul className='lineHeight-34'>
											...
											<li>
												Giving you cost-effective and collaborative tools, including Microsoft
												Teams, Skype for Business and SharePoint Online.
											</li>
											<li>
												Insights from self-service and data discovery with Microsoft Power BI
												for Office 365.
											</li>
											<li>
												Ability to extend standard Office 365 service offerings with managed
												services
											</li>
										</ul>
									</p>
									...
									<p className='lineHeight-24 '>
										...
										<ul className='lineHeight-34 ptext'>
											...
											<li>
												...
												continued success by advising you and your team on the right
