							...
							<div className='bg-lightgrey mb-0 pb-3'>
								<div className=''>
									...
									<div className='d-flex flex-column flex-md-row align-items-center align-items-md-start mt-1 mt-md-3'>
										<img class='w-12 mr-0 mr-md-5' src={EndComputing} alt='Security' />
										<div>
									...
									<div className='d-flex flex-column flex-md-row  align-items-center align-items-md-start mt-1 mt-md-5'>
										<img class='w-12 mr-0 mr-md-5' src={EndSecurity} alt='Affordable Pricing' />
										<div>
											<h5>End-to-end security</h5>
											<p className='mt-2 pcenter'>
												With Multi-Factor Authentication and Active Directory integration,
												Synectiks digital workspace delivers secure remote access to corporate
												resources and helps provide complete security from the device, across
												the network, and into the data center and cloud.
											</p>
										</div>
									</div>
									...
									<div className='d-flex flex-column flex-md-row align-items-center align-items-md-center mt-1 mt-md-5'>
										...
										<div>
											...
											<p className='mt-2 pcenter'>
												Personalized desktops deliver optimal performance and an immersive,
